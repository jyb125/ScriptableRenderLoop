...
#define DEBUGVIEW_FABRIC_SURFACEDATA_AMBIENT_OCCLUSION (1004)
#define DEBUGVIEW_FABRIC_SURFACEDATA_TANGENT_WS (1005)
#define DEBUGVIEW_FABRIC_SURFACEDATA_ANISOTROPY (1006)
#define DEBUGVIEW_FABRIC_SURFACEDATA_SPECULAR (1007)
#define DEBUGVIEW_FABRIC_SURFACEDATA_SUBSURFACE_RADIUS (1008)
#define DEBUGVIEW_FABRIC_SURFACEDATA_THICKNESS (1009)
#define DEBUGVIEW_FABRIC_SURFACEDATA_SUBSURFACE_PROFILE (1010)
#define DEBUGVIEW_FABRIC_SURFACEDATA_SPECULAR_COLOR (1011)
...
#define DEBUGVIEW_FABRIC_BSDFDATA_TANGENT_WS (1036)
#define DEBUGVIEW_FABRIC_BSDFDATA_BITANGENT_WS (1037)
#define DEBUGVIEW_FABRIC_BSDFDATA_ROUGHNESS_T (1038)
#define DEBUGVIEW_FABRIC_BSDFDATA_ROUGHNESS_B (1039)
#define DEBUGVIEW_FABRIC_BSDFDATA_ANISOTROPY (1040)
#define DEBUGVIEW_FABRIC_BSDFDATA_SUBSURFACE_RADIUS (1041)
#define DEBUGVIEW_FABRIC_BSDFDATA_THICKNESS (1042)
#define DEBUGVIEW_FABRIC_BSDFDATA_SUBSURFACE_PROFILE (1043)
#define DEBUGVIEW_FABRIC_BSDFDATA_ENABLE_TRANSMISSION (1044)
#define DEBUGVIEW_FABRIC_BSDFDATA_USE_THIN_OBJECT_MODE (1045)
#define DEBUGVIEW_FABRIC_BSDFDATA_TRANSMITTANCE (1046)
