...
// TODO: Is there a way to automate these output type based on the format declare in Eye.cs ?
...
//#define EYE_DISPLAY_REFERENCE_AREA
//#define EYE_DISPLAY_REFERENCE_IBL
#endif
// Use Lambert diffuse instead of Disney diffuse
// #define EYE_DIFFUSE_LAMBERT_BRDF
// Use optimization of Precomputing LambdaV
// TODO: Test if this is a win
// #define EYE_USE_BSDF_PRE_LAMBDAV
	...
	out float3 specularLighting)
{
	...
	{
		EYE_BSDF(V, L, positionWS, preLightData, bsdfData, diffuseLighting, specularLighting);
	...
	int sampleCount = 128)
{
	...
	for (int i = 0; i < sampleCount; ++i)
	{
		...
		if (NdotL > 0)
		{
			...
			EYE_BSDF(V, L, positionWS, preLightData, bsdfData, lightDiff, lightSpec);
	...
	uint sampleCount = 512)
{
	...
	for (uint i = 0; i < sampleCount; ++i)
	{
		...
		if (illuminance > 0.0)
		{
			EYE_BSDF(V, L, positionWS, preLightData, bsdfData, localDiffuseLighting, localSpecularLighting);
